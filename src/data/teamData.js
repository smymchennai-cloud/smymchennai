...
export const executiveMembers = [
  ...
  { name: 'Kriti Suda', position: 'Executive Member', photo: '/photos/kriti.png', photoPosition: 'center 20%'  },
  { name: 'Laksh Kela', position: 'Executive Member', photo: '/photos/laksh.png', photoPosition: 'center 20%' },
...
export const advisors = [
  ...
  { name: 'Pramod Sarda', position: 'Advisor', photo: '/photos/pramod.png', photoPosition: 'center 20%' },
